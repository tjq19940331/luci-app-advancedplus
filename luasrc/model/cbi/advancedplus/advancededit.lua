...
s:tab("adguardhomeconf",translate("adguardhome"),translate("This page is about configuration")..translate("/etc/AdGuardHome.yaml")..translate("Document content. Automatic restart takes effect after saving the application"))
